...
def soulvoice_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    post_url = "https://pt.soulvoice.club/takeupload.php"
    tags=[]
    time_out=40
    ...
    elif 'study' in file1.pathinfo.type.lower():
        select_type='407'
        logger.info('已成功填写类型为教学')          
    ...
    if '完结' in file1.pathinfo.tags:
        tags.append(8)
    if '杜比' in file1.pathinfo.tags or 'DOLBY' in file1.pathinfo.tags.upper():
        tags.append(12)
