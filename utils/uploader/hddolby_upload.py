...
def hddolby_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    post_url = "https://www.hddolby.com/takeupload.php"
    tags=[]
    time_out=40
    ...
    if file1.pathinfo.audio_format=='AAC':
        ...
        audiocodec_sel='13'
    elif 'M4A' in file1.pathinfo.audio_format.upper():
        audiocodec_sel='11'
    else:
        audiocodec_sel='12'
