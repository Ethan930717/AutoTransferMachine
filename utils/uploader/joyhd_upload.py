...
def joyhd_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    ...
    elif 'movie' in file1.pathinfo.type.lower() and 'WEB' in file1.pathinfo.meijie.upper():
        select_source='4'
        logger.info('已成功填写类型为Movie WEBDL') 
    elif 'movie' in file1.pathinfo.type.lower() and 'BLU' in file1.pathinfo.meijie.upper():
        select_source='55'
        logger.info('已成功填写类型为Movie BLURAY')  
    elif 'movie' in file1.pathinfo.type.lower() and 'DVD' in file1.pathinfo.meijie.upper():
        select_source='79'
        logger.info('已成功填写类型为Movie DVD')         
    elif 'movie' in file1.pathinfo.type.lower() and 'HDTV' in file1.pathinfo.meijie.upper():
        select_source='80'
        logger.info('已成功填写类型为Movie HDTV')
    elif 'movie' in file1.pathinfo.type.lower() and 'ENCODE' in file1.pathinfo.meijie.upper():
        select_source='81'
        logger.info('已成功填写类型为Movie BDRIP')
    elif 'movie' in file1.pathinfo.type.lower() and 'REMUX' in file1.pathinfo.meijie.upper():
        select_source='57'
