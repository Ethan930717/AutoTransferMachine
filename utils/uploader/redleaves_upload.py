...
def redleaves_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    ...
    if 'H' in file1.Videio_Format.upper() and '264' in file1.Videio_Format:
        ...
        codec_sel='10'
        logger.info('已成功选择编码为H265/HEVC')
    elif 'AC' in file1.Videio_Format.lower() and '3' in file1.Videio_Format:
        codec_sel='12'
    ...
    elif 'AAC' in file1.Videio_Format.upper():
        codec_sel='7'
        logger.info('已成功选择编码为AAC') 
    elif 'MP3' in file1.Videio_Format.upper():
        codec_sel='9'
        logger.info('已成功选择编码为MP3') 
    elif 'WAV' in file1.Videio_Format.upper():
        codec_sel='8'
        logger.info('已成功选择编码为WAV') 
    elif 'FLAC' in file1.Videio_Format.upper():
        codec_sel='6'
        logger.info('已成功选择编码为FLAC')  
    elif 'DTS' in file1.Videio_Format.upper():
        codec_sel='11'
