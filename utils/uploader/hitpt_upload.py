...
def hitpt_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    post_url = "https://www.hitpt.com/takeupload.php"
    tags=[]
    time_out=40
    ...
    if '2160' in file1.standard_sel:
        ...
        standard_sel='3'
    elif 'SD' in file1.standard_sel.lower():
        standard_sel='4'
    else:
        standard_sel='1'
    ...
    #选择制作组
    if 'BEAST' in file1.sub.upper():
        team_sel='14'
    elif 'MTEAM' in file1.sub.upper():
        team_sel='16'
    elif 'HIT' in file1.sub.upper():
        team_sel='3'
