...
def ubits_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    post_url = "https://ubits.club/takeupload.php"
    tags=[]
    time_out=40
...
#选择音频编码
    ...
    #选择标签
    if '2160' in file1.standard_sel and 'HDR10+' in file1.pathinfo.tags:
        tags.append(10)
        logger.info('已选择4K HDR10+标签')
    elif '2160' in file1.standard_sel and 'HDR10' in file1.pathinfo.tags:
        tags.append(9)
        logger.info('已选择4K HDR10标签')
    elif '2160' in file1.standard_sel:
        tags.append(7)
        logger.info('已选择4K SDR标签')
