...
def cyanbug_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    post_url = "https://cyanbug.net/takeupload.php"
    tags=[]
    time_out=40
    ...
    if file1.pathinfo.audio_format=='AAC':
        ...
        audiocodec_sel='12'
    elif 'DTS-HD' in file1.pathinfo.audio_format.upper():
        audiocodec_sel='15'
